...
for _c in (MKT["conversations"] + REED["conversations"] + UNDER["conversations"]
           ...
           + SCRIVENER["conversations"] + ARCHIVE["conversations"]):
...
<header>
 ...
 <span class="sub">twenty walkable zones · a whole saga + side quests · the way they answer depends on who you are — and what you did</span>
