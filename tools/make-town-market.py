...
NPC_SENSE = {
    ...
    "lz.mother": {"dc": 9, "text": "*(You turn your sense on the still woman cradling an emptiness and find, to your surprise, not a loop of grief but a loop of triumph held so tight it has become a cage. Wren ran back into a burning house for her six-year-old, Annabel, got the girl out through a high window into safe hands, and the roof took her before she could follow. Your cold reads the truth the smoke hides from her: she is not trapped in her death. She is trapped in her one perfect victory — the four seconds when the child cleared the window and Wren knew beyond doubting that her girl would live and she had made it so. She replays it not to suffer but because it is the only place left where she gets to save her daughter again; to step out feels like letting the child fall, and worse, like stepping into the sixty empty years where Bell grew old without her and she was nobody's mother in the cold. She does not need rescuing from a horror. She needs to learn the victory is permanent — that Bell stayed saved, lived a whole long life, died warm with grandchildren in the room, and stays saved whether Wren watches or not. The fire is not where the child is. The child is out the window. Wren can carry the rescue instead of the burning, and the laugh she cannot reach inside the smoke is waiting for her outside it.)*"},
