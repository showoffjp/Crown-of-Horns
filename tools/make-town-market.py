...
for _c in (MKT["conversations"] + REED["conversations"] + UNDER["conversations"]
           ...
           + ASSIZE["conversations"] + SIEGE["conversations"] + WAKE["conversations"]):
...
<header>
 ...
 <span class="sub">twenty-four walkable zones · a whole saga + side quests · the way they answer depends on who you are — and what you did</span>
