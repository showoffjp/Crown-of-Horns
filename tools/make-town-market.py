...
for _c in (MKT["conversations"] + REED["conversations"] + UNDER["conversations"]
           ...
           + ASSIZE["conversations"] + SIEGE["conversations"] + WAKE["conversations"] + INQUEST["conversations"] + THINPLACE["conversations"] + DISPUTATION["conversations"] + CONFESSION["conversations"] + BOAST["conversations"] + CANTOR["conversations"] + MEMORY["conversations"]):
...
<header>
 ...
 <span class="sub">thirty-one walkable zones · a whole saga + side quests · the way they answer depends on who you are — and what you did</span>
